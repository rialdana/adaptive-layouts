...
package com.example.adaptivelayouts.ui.utils
...
/**
 * Composition local that could be used to get the current screen size and change any attribute on a composable
 */
val LocalWindowsSize = compositionLocalOf { WindowSize.Compact }
